...
using System.Linq;
using System.Text;
using HomeMade.Domain.Entities.BankTransaction;
...

{
    public class ApplicationDbContext : IdentityDbContext<User, CustomRole, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductRate>().HasMany(e => e.Notification).WithOne(e => e.ProductRate).IsRequired(false);
